PROPOSAL_TEMPLATE = '''
    ...
    **Executive Summary**
    ...
    Example Ex 1:
    """
        Nitor Infotech Inc. (Nitor) is excited to present this proposal for the Development of HRMS for Performance Appraisal and Review Process (PAPR). EXIM Bank of India (EXIM), premier financial institution committed to promoting international trade and economic development, seeks to develop a new Human Resource Management System (HRMS) tailored to streamline and enhance its Performance Appraisal and Review Process (PAPR). This initiative is designed to address the limitations of existing systems while creating a purpose-built platform that aligns with EXIM's strategic priorities and operational needs.
        The proposed HRMS will be a comprehensive and scalable solution that integrates essential functionalities such as employee profile management, leave tracking, and appraisal workflows. It will introduce advanced capabilities like automated notifications, customizable reporting, and dedicated modules for managing contractual employees. By replacing current fragmented systems (TICE, Darwinbox, and Mindteck) with a unified platform, the new HRMS will deliver enhanced usability, seamless data integration, and robust security.
    """
    Example Ex 2:
    """
